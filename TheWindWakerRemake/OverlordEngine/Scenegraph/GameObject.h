...
public:
	...
	void AddTagg(Tag tag) { m_Tags.push_back(tag); }
	bool HasTag(Tag tag) { return (std::find(m_Tags.begin(), m_Tags.end(), tag) != m_Tags.end()); }
...
private:
	...
	bool m_IsInitialized{}, m_IsActive{true};
