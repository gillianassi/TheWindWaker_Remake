...
#pragma region POST-PROCESSING PASS
    ...
    if (m_PostProcessingMaterials.size() > 0)
    {
        ...
        for (PostProcessingMaterial* pPPMat : m_PostProcessingMaterials)
        {
            // For Each Material
        ...
        SpriteRenderer::Get()->DrawImmediate(m_SceneContext.d3dContext, pPrevRT->GetColorShaderResourceView(), DirectX::XMFLOAT2{ 0.f, 0.f });
    }
    //Done!
#pragma endregion
}
