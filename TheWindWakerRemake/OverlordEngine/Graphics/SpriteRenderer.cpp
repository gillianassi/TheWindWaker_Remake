...
void SpriteRenderer::UpdateBuffer(const SceneContext& sceneContext)
{
	...
	{	
		...
		// Use the device context to map the vertex buffer to the mapped resource
